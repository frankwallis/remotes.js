 ...
 * @api public
 */
var debower = regeneratorRuntime.mark(function callee$0$0(bowerJson) {
  var result, main, key, qualified;
  ...
  return regeneratorRuntime.wrap(function callee$0$0$(context$1$0) {
    ...
    case 0:
      ...
      context$1$0.t0 = regeneratorRuntime.keys(bowerJson.dependencies);
    case 18:
    ...
    case 26:
      ...
      context$1$0.t2 = regeneratorRuntime.keys(bowerJson.devDependencies);
    case 29:
      if ((context$1$0.t3 = context$1$0.t2()).done) {
        context$1$0.next = 37;
        break;
      }

      key = context$1$0.t3.value;
      context$1$0.next = 33;
      return lookup(key);
    case 33:
      qualified = context$1$0.sent;
 ...
 * @api private
 */
var lookup = regeneratorRuntime.mark(function callee$0$1(packageName) {
  var result;

  return regeneratorRuntime.wrap(function callee$0$1$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
    case 0:
      result = lookupCache[packageName];
      ...
      context$1$0.next = 4;
      return bowerLookup(packageName);
    case 4:
